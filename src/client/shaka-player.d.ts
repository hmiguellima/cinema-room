declare namespace shaka {
  ...
  starting after this time should be assumed to be unavailable.
    ...
    namespace util {
        namespace FairPlayUtils {
            function defaultGetContentId(initData: any): any;
            function initDataTransform(initData: any, contentId: any, cert: any): any;
        }
  ...
  alphabet or the alternate "base64url" alphabet.
         */
             ...
             */
            function toStandardBase64(data: any): any;
        }
    }
    namespace polyfill {
        /**
  ...
  per ({@link shaka.abr.SimpleAbrManager.SWITCH_INTERVAL_MS}).
    ...
    namespace extern {
        ...
        class TextDisplayer {
            ...
            append(cues: Array<text.Cue>): void;
            destroy(): void;
        ...
        interface ThumbnailTileSegment {
            tileUrl: string;
            startPosition: number;
            duration: numbe;
        }

        interface ThumbnailTileStream {
            id: string;
            tileHeight: number;
            tileWidth: number;
            ...
            maxHorizontalThumbnailCount: number;
            maxVerticalThumbnailCount: number;        
            thumbnailSegments: Array<extern.ThumbnailTileSegment>;
        }
    ...
    namespace PlayerEvents {
        ...
        interface TimelineRegionAddedEvent extends util.ShakaEvent {
            ...
            detail: extern.TimelineRegionInfo; // {shaka.extern.TimelineRegionInfo}
        }
        ...
        interface AvailableThumbnailStreamChangedEvent extends util.ShakaEvent {
            type: 'availablethumbnailstreamchanged';
            thumbnailStream: extern.ThumbnailTileStream; // {shaka.extern.ThumbnailTileVariant}
        }

        interface ManifestParsedEvent extends util.ShakaEvent {
            type: 'manifestparsed';
        }
        ...
        interface VariantChangedEvent extends util.ShakaEvent {
            type: 'variantchanged';
        }
        ...
        interface PlayerEventMap {
            ...
            availablethumbnailstreamchanged: AvailableThumbnailStreamChangedEvent;
            buffering: BufferingEvent;
            loading: LoadingEvent;
            loaded: LoadedEvent;
            unloading: UnloadingEvent;
            texttrackvisibility: TextTrackVisibilityEvent;
            manifestparsed: ManifestParsedEvent;
            ...
            streaming: StreamingEvent; // fired after the manifest has been parsed and track info is available
            emsg: EmsgEvent;
        }
    }
  ...
  before being able to switch.
       */
        ...
        /**
       * Return a list of thumbnail variants
       */
        getThumbnailVariants(): Array<shaka.extern.ThumbnailVariant>;
        /**
       * Return a thumbnail stream for a specific variant
       */
        selectThumbnailVariant(thumbnailVariant: shaka.extern.ThumbnailVariant): Promise<shaka.extern.ThumbnailTileStream>;
        /**
  ...
  track selections.
       */
        selectVariantTrack(track: shaka.extern.Track, opt_clearBuffer?: any): void;
        /**
  ...
  Period.
       */
        getTextLanguagesAndRoles(): Array<{ language: string; role: string }>;
        /**
  ...
  Period.
       */
         ...
         * which allows applying custom styles to text nodes.
         */
        setVideoContainer(videoContainer: any): void;
        /**
